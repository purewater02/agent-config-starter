...
- 핵심은 *누가 썼느냐(사람 vs LLM)*가 아니라 **큐레이션 여부**입니다. 한 연구(ETH Zürich, *Evaluating AGENTS.md*, 2026)에 따르면 — naive하게 자동 생성해 *그대로 쌓은* 컨텍스트 파일은 작업 성공률을 오히려 깎았고, 사람이 *의도적으로 추린* 파일은 (소폭) 도움이 됐습니다. 양쪽 다 추론 비용은 늘립니다.
- 그래서 이 킷의 목표는 "더 쓰기"가 아니라 **신호만 남기고 덜어내기**입니다. LLM은 *생성*이 아니라 *압축·삭제*에 쓰는 게 맞습니다 — 판단은 사람이.
